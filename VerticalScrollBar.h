#ifndef HORIZONTAL_SCROLL_BAR
#define HORIZONTAL_SCROLL_BAR
#include <windows.h>

class VerticalScrollBar {
public:
	VerticalScrollBar(int x, int y, int width, int height, int minValue=0, int maxValue=100, int defaultValue=50);
	void render();
